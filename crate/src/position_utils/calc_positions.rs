...
use super::map_terrain::TERRAIN_LINES;
// use super::map_terrain::ObstaclesLazyStatics;
use crate::constants::{
            ...
            static ref PRECALCULATED_OBSTACLES_MAP: Vec<u8> = {
                ...
                (0..OBSTACLES_MAP_WIDTH * OBSTACLES_MAP_HEIGHT)
                    ...
                    .map(|index| {
                        ...
                        let squad_will_collide_with_any_obstacle =
                            check_squad_distance_from_obstacles
                                .iter()
                                .any(|(mod_x, mod_y)| {
                                    CalcPositions::collision_checking(
                                        (x + mod_x).round() as i16,
