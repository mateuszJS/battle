...
lazy_static! {
  static ref SOLIDER_DETAILS: SquadDetails = SquadDetails {
      movement_speed: 2.0,
      hp: 100.0,
      production_time: 200,
      members_number: 7,
  ...
  static ref RAPTOR_DETAILS: SquadDetails = SquadDetails {
      movement_speed: 2.0,
      hp: 120.0,
      production_time: 100,
      members_number: 3,
  ...
  static ref PORTAL_DETAILS: SquadDetails = SquadDetails {
      movement_speed: 0.0,
      hp: 2000.0,
      production_time: 0,
      members_number: 1,
  ...
  static ref STRATEGIC_POINT_DETAILS: SquadDetails = SquadDetails {
      movement_speed: 0.0,
      hp: 0.0,
      production_time: 0,
      members_number: 0,
