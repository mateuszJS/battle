...
pub const THRESHOLD_SQUAD_ON_POSITION: f32 = 10.0;
pub const ATTACKERS_DISTANCE: f32 =
  WEAPON_RANGE - NORMAL_SQUAD_RADIUS - THRESHOLD_SQUAD_ON_POSITION;

pub const MANAGE_HUNTERS_PERIOD: u32 = 40;
